...
export const Search = () => {
  ...
  return (
    <>
     <div className="flex items-center justify-center p-5 sticky top-0 z-50">
    ...
    <div className=''>
      {isError.show ? (<div className=' w-full text-lg text-red-500 text-center'> {isError.msg} </div>) : <></>}
    </div>
